...
def parser():
    ...
    parser.add_argument('--log_root', default='./oest/cifar10/log', 
        help='the directory to save the logs or other imformations (e.g. images)')
    parser.add_argument('--model_root', default='./oest/cifar10/checkpoint', help='the directory to save the models')
    parser.add_argument('--load_checkpoint', default='./cifar10_resnet18_32x32/s0/last_epoch100.ckpt')
